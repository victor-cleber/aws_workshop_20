...
output "vpc-db-subnet-1a-id" {
  description = "VPC: Private Subnet 1a:ID"
  value       = aws_subnet.vpc-db-subnet-1a.id
}

output "vpc-db-subnet-1b-id" {
  description = "VPC: Private Subnet 1b:ID"
  value       = aws_subnet.vpc-db-subnet-1b.id
}
...
output "vpc-sg-alb-glpi-id" {
  ...
  value       = aws_security_group.vpc-sg-alb-glpi.id
}

output "vpc-sg-alb-glpi-name" {
  description = "VPC: Security group for ALB GLPI:Name"
  value       = aws_security_group.vpc-sg-alb-glpi.name
}
